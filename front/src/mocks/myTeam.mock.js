...
export const myTeamStatsMock = {
  ...
  mapWinrates: [
    ...
    { map: 'split', win: 11, lose: 7, winRate: 63 },
    { map: 'lotus', win: 8, lose: 12, winRate: 40 },
    { map: 'abyss', win: 6, lose: 4, winRate: 60 },
    { map: 'breeze', win: 5, lose: 5, winRate: 50 },
    { map: 'corrode', win: 4, lose: 4, winRate: 50 },
    { map: 'fracture', win: 7, lose: 6, winRate: 54 },
    { map: 'icebox', win: 9, lose: 8, winRate: 53 },
    { map: 'pearl', win: 6, lose: 7, winRate: 46 },
    { map: 'summit', win: 5, lose: 4, winRate: 55 },
    { map: 'sunset', win: 8, lose: 7, winRate: 53 },
  ],
  matchHistory: [
...
export const myTeamAnalysisMock = {
  ...
  mapInfoByMap: {
    'ascent': {
      ...
      matchSample: 13,
      combos: [
        { agents: ['jett', 'omen', 'killjoy', 'sova', 'reyna'], result: 'win' },
        { agents: ['jett', 'omen', 'sova', 'cypher', 'viper'], result: 'lose' },
      ],
      comboAce: [
        { name: 'Zeta', acs: 268 },
        { name: 'Rho', acs: 241 },
    ...
    'lotus': {
      ...
      comboWeakness: [
        { name: 'Milo', fd: 28, acs: 187 },
        { name: 'Vex', fd: 24, acs: 170 },
      ],
    },
    'abyss': {
      mapWinRate: 60, atkWinRate: 52, defWinRate: 62,
    ...
    'breeze': {
      mapWinRate: 50, atkWinRate: 48, defWinRate: 52,
    ...
    'corrode': {
      mapWinRate: 50, atkWinRate: 50, defWinRate: 50,
    ...
    'fracture': {
      mapWinRate: 54, atkWinRate: 53, defWinRate: 55,
    ...
    'icebox': {
      mapWinRate: 53, atkWinRate: 49, defWinRate: 57,
    ...
    'pearl': {
      mapWinRate: 46, atkWinRate: 42, defWinRate: 50,
    ...
    'summit': {
      mapWinRate: 55, atkWinRate: 51, defWinRate: 59,
    ...
    'sunset': {
      mapWinRate: 53, atkWinRate: 50, defWinRate: 56,
      preferredSites: { A: 40, B: 40, center: 20 },
      avgSpikePlantTime: 32,
      matchSample: 15,
      combos: [
