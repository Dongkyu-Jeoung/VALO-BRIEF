...
// API 기본 설정
// ------------------------------------------------------------
// - VITE_API_BASE_URL이 비어있으면 mock 사용(Docker의 VITE_USE_SAME_ORIGIN=true는 실제 API).
...
export const USE_MOCK_ONLY = API_BASE_URL === '' && import.meta.env.VITE_USE_SAME_ORIGIN !== 'true';
